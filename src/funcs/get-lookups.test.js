...
describe("getLeagueStatusEnums", () => {
  ...
  xtest("should get values", () => validateValid(func, url, data));
  xtest("should handle missing handler", () => validateMissing(func, url, data));
  xtest("should handle errors", () => validateError(func));
});
