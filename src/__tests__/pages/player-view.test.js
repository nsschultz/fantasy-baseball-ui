...
describe("Player View Page", () => {
  ...
  const mutatePlayer = (wrapper) => {
    ...
    wrapper
      ...
      .find("#lastName")
      .at(0)
      .simulate("change", { target: { value: "Oppman" } });
    wrapper
      .find("input")
      .find("#age")
      .at(0)
    ...
    wrapper
      ...
      .find("#positions")
      .at(0)
      .simulate("change", { target: { value: "SP" } });
    wrapper
      .find("input")
      .find("#team")
      .at(0)
      .simulate("change", { target: { value: "SF" } });
    wrapper
      .find(findSelect)
      .find("#status")
      .find("input")
    ...
    wrapper
      .find("input")
      .find("#draftedPercentage")
      .at(0)
      .simulate("change", { target: { value: 0.07 } });
  };
