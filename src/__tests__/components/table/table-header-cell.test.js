...
describe("Table Header Cell", () => {
  ...
  it("should render with sort ascending direction", () => {
    validateTableCell("right", "asc", field);
  });

  it("should render with sort descending direction", () => {
    validateTableCell("right", "desc", field);
  });

  it("should render without sort direction", () => {
    validateTableCell("left", false, "OtherField");
  });
